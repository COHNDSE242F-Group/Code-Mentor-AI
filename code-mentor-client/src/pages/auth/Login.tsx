        ...
        <div className="flex justify-center">
          <div className="text-center">
            <h1 className="text-3xl font-bold flex items-center justify-center">
              <span className="bg-[#FFC107] text-[#0D47A1] p-2 rounded mr-2 text-xl">CM</span>
              CodeMentorAI
            </h1>
            <h2 className="mt-6 text-2xl font-bold text-gray-900">Sign in to your account</h2>
            <p className="mt-2 text-sm text-gray-600">
              Or{' '}
              <Link to="/signup" className="font-medium text-[#0D47A1] hover:text-blue-800">
        ...
        <Card>
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input
                  ...
                  } rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#0D47A1] focus:border-[#0D47A1] sm:text-sm`}
                  placeholder="admin or you@example.com"
                />
              </div>
              {errors.usernameOrEmail && <p className="mt-2 text-sm text-red-600">{errors.usernameOrEmail}</p>}
            </div>
            <div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input id="remember-me" name="remember-me" type="checkbox" className="h-4 w-4 text-[#0D47A1] focus:ring-[#0D47A1] border-gray-300 rounded" />
                <label htmlFor="remember-me" className="ml-2 block text-sm text-gray-900">
                  Remember me
                </label>
              </div>
              <div className="text-sm">
                <Link to="/forgot-password" className="font-medium text-[#0D47A1] hover:text-blue-800">
          ...
          <div className="mt-6">
            ...
            <div className="mt-6 grid grid-cols-2 gap-3">
              <button type="button" className="w-full inline-flex justify-center py-2 px-4 border border-gray-300 rounded-md shadow-sm bg-white text-sm font-medium text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#0D47A1]">
