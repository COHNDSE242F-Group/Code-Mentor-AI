...
const Signup = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      // For demo purposes, navigate to email verification page
          ...
          <form className="space-y-6" onSubmit={handleSubmit}>
            <div>
              ...
              <div className="mt-1 relative">
                ...
                <input id="name" name="name" type="text" autoComplete="name" value={name} onChange={e => setName(e.target.value)} className={`appearance-none block w-full pl-10 pr-3 py-2 border ${errors.name ? 'border-red-300' : 'border-gray-300'} rounded-md shadow-sm placeholder-gray-400 focus:outline-none focus:ring-[#0D47A1] focus:border-[#0D47A1] sm:text-sm`} placeholder="John Doe" />
              </div>
            ...
            <div className="flex items-center">
              <input id="terms" name="terms" type="checkbox" className="h-4 w-4 text-[#0D47A1] focus:ring-[#0D47A1] border-gray-300 rounded" required />
